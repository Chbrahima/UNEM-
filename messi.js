...
document.addEventListener('DOMContentLoaded', function() {
    ...
    addModuleButton.addEventListener('click', function() {
        ...
        addCourseButton.addEventListener('click', function() {
            ...
            resultElementMatiere.textContent = 'Moyenne de la matière : ';
    ...
    calculateButton.addEventListener('click', function() {
        ...
        modules.forEach(module => {
            ...
            moduleCourses.forEach(course => {
                ...
                let resultElementMatiere = course.querySelector('p');
    ...
    cancelButton.addEventListener('click', function() {
        // Efface toutes les entrées utilisateur
    ...
    deleteModuleButton.addEventListener('click', function() {
        // Supprime le dernier module ajouté
    ...
    // Ajout du bouton "Annuler" et "Supprimer Module" à la fin du document
